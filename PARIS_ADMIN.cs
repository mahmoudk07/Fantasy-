...
namespace PROJECT
{
    public partial class PARIS_ADMIN : Form
    {
        ...
        private void UPBUDGET_Click(object sender, EventArgs e)
        {
            ...
            {
                int result = controllerObj.UPDATE_BUDGET(TEXTBUDGET.Text, Convert.ToInt32(600));
                if (result == 0)
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                int result = controllerObj.UPDATE_STADIUM(Convert.ToInt32(textBox1.Text), 600);
                if (result == 0)
                {
                    MessageBox.Show("No rows are updated");
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int result = controllerObj.DELETES(Convert.ToInt32(textBox4.Text), Convert.ToInt32(textBox2.Text), 600);
